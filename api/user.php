...
if($action=="1"){         //Action 1 for Update Account
  ...
  $sq1 = "SELECT * FROM user WHERE phone = '$phone' LIMIT 1;";
  if($conn->query($sq1)){

      $sql = "UPDATE user SET username='$name', fcm='$fcm', image='$image',email='$email',address='$adr',location='$geo' WHERE phone = '$phone' LIMIT 1";
